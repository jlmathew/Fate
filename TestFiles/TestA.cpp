...
main ()
{
  ...
  bool status = config.FirstNodeFileConfig ("xmlDefinitions/total.xml");
...
*/
  ...
  //print debug via return packet


  //TODO: forwarding and discovery
  //TODO: GUI design node, configure utilities
  //Networking Atomic Evaluation functional units configurable: N A F C U,  F A M E (function atomic module evaluation) unites (fame)?

  //doxygen, indent, bsd license code
